...
Setiap produk mempunyai data dasar:
...
```text
Gula 1 kg
type = PACKAGED_WEIGHT
selling_unit = pack
```

Produk digital dipisahkan dari inventory fisik.
...
Quantity disimpan sebagai decimal.
...
Sistem tidak menggunakan integer-only quantity.
